...
public class Implement {
	...
	private static WebElement until;
	...
	public static void closePopup() {
		...
		WebElement popup = wait1.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[@data-gaaction='popup.auth.close']")));
		popup.click();
	...
	public static void collections() {
		...
		until = new WebDriverWait(driver,Duration.ofSeconds(30)).until(ExpectedConditions.visibilityOf(t1));
	...
	public static void giftcards() throws InterruptedException {
		...
		value1.sendKeys("4,00,000");
		Thread.sleep(2000);
		value1.clear();
		value1.sendKeys("500");
		Thread.sleep(2000);
		value1.clear();
		value1.sendKeys("6,00,000");
		Thread.sleep(2000);
		...
		driver.findElement(By.id("ip_4036288348")).sendKeys("aswin");
		WebElement email = driver.findElement(By.id("ip_137656023"));
		email.sendKeys("shobnagmail.com");
		driver.findElement(By.id("ip_1082986083")).sendKeys("shalini");
		driver.findElement(By.id("ip_4081352456")).sendKeys("vichu@gmail.com");
